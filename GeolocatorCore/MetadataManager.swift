...
//    
//    
//    init(geocoder: ReverseGeocoder, location: ExifImage, index: Int, manager: MetadataManager) {
...
//        
//        executing(true)
//        manager.progress.localizedDescription = "Reverse geocoding \(location[TagGroup.File.FileName]!)"
//        
